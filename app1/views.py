...
from app1.models import Post, Comment, PostLike
from rest_framework.response import Response
from app1.serializers import PostListSerializer, CommentListSerializer, CommentsValidateSerializer, \
    PostsValidateSerializer, UserLoginValidateSerializer, UserRegisterValidateSerializer
...
def post_list_views(request):
    ...
    if request.method == "POST":
        ...
        post = Post.objects.create(title=request.data["title"], text=request.data["text"], is_like=request.data["is_like"])
